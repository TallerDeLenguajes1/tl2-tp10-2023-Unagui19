    ...
    public class TableroRepository:ITableroRepository
    {
        ...
        public void Create(Tablero Tablero)
        {
            try{
                ...
                throw new Exception("Error al recuperar la lista de tableros",ex);
        ...
        public void Update (Tablero tablero, int id)//actualizar la Tarea
        {
            try{
                ...
                throw new Exception("Error al modificar el tablero requerido",ex);
            }
        }
        public Tablero GetById(int id)
        {
            ...
            if (tablero.Id == 0)
            {
                throw new Exception ("Error al recuperar el tablero");
            }
            return (tablero);
        }

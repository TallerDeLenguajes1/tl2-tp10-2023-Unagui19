...
namespace tl2_tp10_2023_Unagui19.Repositorios
{
    public class TareaRepository:ITareaRepository
    {
        ...
        public void Create(Tarea tarea)
        {
            ...
            {
                throw new Exception ("Error en la obtencion de la tarea",ex);
            }
        }
        public void Update(Tarea TareaMod, int idTarea)//actualizar la Tarea
        {
            ...
            {
                throw new Exception ("Error en la modificacion del usuario",ex);
            }
        }
        ...
        public Tarea GetById(int id)
        {
            ...
            if (TareaRecup.Id == 0)
            {
                throw new Exception ("Error al recuperar la tarea");
            }
            return (TareaRecup);
        }
        public List<Tarea> GetAll()
        {
            try{
                ...
                throw new Exception("Error al recuperar la lista de tareas",ex);
